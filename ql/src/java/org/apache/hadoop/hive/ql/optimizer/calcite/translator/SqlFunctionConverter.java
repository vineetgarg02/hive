...
public class SqlFunctionConverter {
  ...
  private static class StaticBlockBuilder {
    ...
    StaticBlockBuilder() {
      ...
      registerFunction("is distinct from", SqlStdOperatorTable.IS_DISTINCT_FROM, hToken(HiveParser.TOK_ISDISTINCTFROM, "TOK_ISNULL"));
      registerFunction("is not distinct from", SqlStdOperatorTable.IS_NOT_DISTINCT_FROM, hToken(HiveParser.TOK_ISNOTDISTINCTFROM, "TOK_ISNULL"));
