            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.metadata = new ArrayList<ByteBuffer>(_list709.size);
                ByteBuffer _elem710;
                for (int _i711 = 0; _i711 < _list709.size; ++_i711)
                {
                  _elem710 = iprot.readBinary();
                  struct.metadata.add(_elem710);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PutFileMetadataRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.fileIds != null) {
        oprot.writeFieldBegin(FILE_IDS_FIELD_DESC);
        {
          ...
          for (long _iter712 : struct.fileIds)
          {
      ...
      if (struct.metadata != null) {
        oprot.writeFieldBegin(METADATA_FIELD_DESC);
        {
          ...
          for (ByteBuffer _iter713 : struct.metadata)
          {
            oprot.writeBinary(_iter713);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class PutFileMetadataRequestTupleScheme extends TupleScheme<PutFileMetadataRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, PutFileMetadataRequest struct) throws org.apache.thrift.TException {
      ...
      }
      {
        ...
        for (ByteBuffer _iter715 : struct.metadata)
        {
          oprot.writeBinary(_iter715);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PutFileMetadataRequest struct) throws org.apache.thrift.TException {
      ...
      struct.setFileIdsIsSet(true);
      {
        ...
        struct.metadata = new ArrayList<ByteBuffer>(_list719.size);
        ByteBuffer _elem720;
        for (int _i721 = 0; _i721 < _list719.size; ++_i721)
        {
          _elem720 = iprot.readBinary();
          struct.metadata.add(_elem720);
        }
      }
      struct.setMetadataIsSet(true);
