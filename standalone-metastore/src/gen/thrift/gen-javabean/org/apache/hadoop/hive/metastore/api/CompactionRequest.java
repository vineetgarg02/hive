...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class CompactionRequest implements org.apache.thrift.TBase<CompactionRequest, CompactionRequest._Fields>, java.io.Serializable, Cloneable, Comparable<CompactionRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.properties = new HashMap<String,String>(2*_map660.size);
                String _key661;
                String _val662;
                for (int _i663 = 0; _i663 < _map660.size; ++_i663)
                {
                  ...
                  struct.properties.put(_key661, _val662);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.properties != null) {
        if (struct.isSetProperties()) {
          oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter664 : struct.properties.entrySet())
            {
              oprot.writeString(_iter664.getKey());
              oprot.writeString(_iter664.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class CompactionRequestTupleScheme extends TupleScheme<CompactionRequest> {
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (Map.Entry<String, String> _iter665 : struct.properties.entrySet())
          {
            oprot.writeString(_iter665.getKey());
            oprot.writeString(_iter665.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, CompactionRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map666 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
