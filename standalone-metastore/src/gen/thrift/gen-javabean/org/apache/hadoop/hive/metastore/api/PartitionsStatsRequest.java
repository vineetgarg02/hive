  ...
  private static class PartitionsStatsRequestTupleScheme extends TupleScheme<PartitionsStatsRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, PartitionsStatsRequest struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.tblName);
      {
        ...
        for (String _iter468 : struct.colNames)
        {
      ...
      }
      {
        ...
        for (String _iter469 : struct.partNames)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PartitionsStatsRequest struct) throws org.apache.thrift.TException {
      ...
      struct.setTblNameIsSet(true);
      {
        ...
        struct.colNames = new ArrayList<String>(_list470.size);
        String _elem471;
        for (int _i472 = 0; _i472 < _list470.size; ++_i472)
        {
          _elem471 = iprot.readString();
          struct.colNames.add(_elem471);
        }
      }
      struct.setColNamesIsSet(true);
      {
        ...
        struct.partNames = new ArrayList<String>(_list473.size);
        String _elem474;
        for (int _i475 = 0; _i475 < _list473.size; ++_i475)
        {
          _elem474 = iprot.readString();
          struct.partNames.add(_elem474);
        }
      }
      struct.setPartNamesIsSet(true);
    }
