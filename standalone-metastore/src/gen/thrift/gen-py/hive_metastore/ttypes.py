      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i508 in xrange(_size504):
            _elem509 = LockComponent()
            _elem509.read(iprot)
            self.component.append(_elem509)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i515 in xrange(_size511):
            _elem516 = ShowLocksResponseElement()
            _elem516.read(iprot)
            self.locks.append(_elem516)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.SET:
          self.nosuch = set()
          (_etype527, _size524) = iprot.readSetBegin()
          for _i528 in xrange(_size524):
            _elem529 = iprot.readI64()
            self.nosuch.add(_elem529)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      else:
...
class CompactionRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i536 in xrange(_size532):
            ...
            self.properties[_key537] = _val538
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.properties is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.properties))
      for kiter539,viter540 in self.properties.items():
        oprot.writeString(kiter539)
        oprot.writeString(viter540)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i545 in xrange(_size541):
            _elem546 = ShowCompactResponseElement()
            _elem546.read(iprot)
            self.compacts.append(_elem546)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class AddDynamicPartitions:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i552 in xrange(_size548):
            ...
            self.partitionnames.append(_elem553)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
  ...
  def write(self, oprot):
    ...
    if self.partitionnames is not None:
      ...
      for iter554 in self.partitionnames:
...
class CreationMetadata:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.SET:
          self.tablesUsed = set()
          (_etype558, _size555) = iprot.readSetBegin()
          for _i559 in xrange(_size555):
            _elem560 = iprot.readString()
            self.tablesUsed.add(_elem560)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.tablesUsed is not None:
      ...
      for iter561 in self.tablesUsed:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i566 in xrange(_size562):
            _elem567 = NotificationEvent()
            _elem567.read(iprot)
            self.events.append(_elem567)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class InsertEventRequestData:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i573 in xrange(_size569):
            ...
            self.filesAdded.append(_elem574)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.LIST:
          ...
          for _i579 in xrange(_size575):
            ...
            self.filesAddedChecksum.append(_elem580)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.filesAdded is not None:
      ...
      for iter581 in self.filesAdded:
    ...
    if self.filesAddedChecksum is not None:
      ...
      for iter582 in self.filesAddedChecksum:
...
class FireEventRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i587 in xrange(_size583):
            ...
            self.partitionVals.append(_elem588)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.partitionVals is not None:
      ...
      for iter589 in self.partitionVals:
...
class GetFileMetadataByExprResult:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i594 in xrange(_size590):
            ...
            _val596 = MetadataPpdResult()
            _val596.read(iprot)
            self.metadata[_key595] = _val596
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.metadata is not None:
      ...
      for kiter597,viter598 in self.metadata.items():
        oprot.writeI64(kiter597)
        viter598.write(oprot)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
...
class GetFileMetadataResult:
  ...
  def write(self, oprot):
    ...
    if self.metadata is not None:
      ...
      for kiter613,viter614 in self.metadata.items():
        oprot.writeI64(kiter613)
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i647 in xrange(_size643):
            _elem648 = Function()
            _elem648.read(iprot)
            self.functions.append(_elem648)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class ClientCapabilities:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i654 in xrange(_size650):
            _elem655 = iprot.readI32()
            self.values.append(_elem655)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.values is not None:
      ...
      for iter656 in self.values:
        oprot.writeI32(iter656)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class Materialization:
  ...
  def write(self, oprot):
    ...
    if self.tablesUsed is not None:
      ...
      oprot.writeSetBegin(TType.STRING, len(self.tablesUsed))
      for iter677 in self.tablesUsed:
...
class WMFullResourcePlan:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i700 in xrange(_size696):
            _elem701 = WMPoolTrigger()
            _elem701.read(iprot)
            self.poolTriggers.append(_elem701)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.poolTriggers is not None:
      ...
      for iter705 in self.poolTriggers:
        iter705.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class WMGetAllResourcePlanResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i710 in xrange(_size706):
            _elem711 = WMResourcePlan()
            _elem711.read(iprot)
            self.resourcePlans.append(_elem711)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.resourcePlans is not None:
      ...
      for iter712 in self.resourcePlans:
        iter712.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
