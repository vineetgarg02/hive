 ...
 */
public class EstimateUniqueKeys {
  //~ Constructors -----------------------------------------------------------
  private EstimateUniqueKeys() {}

  //~ Methods ----------------------------------------------------------------

  public static Set<ImmutableBitSet> getUniqueKeys(HiveFilter rel,
                                            boolean ignoreNulls) {
    return getUniqueKeys(rel.getInput(), ignoreNulls);
  }

  public static Set<ImmutableBitSet> getUniqueKeys(HiveSortLimit rel,
                                            boolean ignoreNulls) {
    return getUniqueKeys(rel.getInput(), ignoreNulls);
  }

  public static Set<ImmutableBitSet> getUniqueKeys(Correlate rel,
                                            boolean ignoreNulls) {
    return getUniqueKeys(rel.getLeft(), ignoreNulls);
  }
  ...
  public static Set<ImmutableBitSet> getUniqueKeys(HiveProject rel,
                                            boolean ignoreNulls) {
  ...
  public static Set<ImmutableBitSet> getUniqueKeys(HiveJoin rel,
                                            boolean ignoreNulls) {
    ...
    final Set<ImmutableBitSet> leftSet = getUniqueKeys(left, ignoreNulls);
    Set<ImmutableBitSet> rightSet = null;

    final Set<ImmutableBitSet> tmpRightSet = getUniqueKeys(right, ignoreNulls);
  ...
  public static Set<ImmutableBitSet> getUniqueKeys(HiveSemiJoin rel,
                                            boolean ignoreNulls) {
  ...
  public static Set<ImmutableBitSet> getUniqueKeys(HiveAggregate rel,
                                            boolean ignoreNulls) {
    // group by keys form a unique key
    return ImmutableSet.of(rel.getGroupSet());
  }

  public static Set<ImmutableBitSet> getUniqueKeys(SetOp rel,
                                            boolean ignoreNulls) {
    if (!rel.all) {
  ...
  public static Set<ImmutableBitSet> getUniqueKeys(RelNode rel,
    ...
    if (rel instanceof HiveFilter) {
      return getUniqueKeys((HiveFilter) rel, ignoreNulls);
    } else if (rel instanceof HiveSortLimit) {
      return getUniqueKeys((HiveSortLimit) rel, ignoreNulls);
    } else if (rel instanceof Correlate) {
      return getUniqueKeys((Correlate) rel, ignoreNulls);
    } else if (rel instanceof HiveProject) {
      return getUniqueKeys((HiveProject) rel, ignoreNulls);
    } else if (rel instanceof HiveJoin) {
      return getUniqueKeys((HiveJoin) rel, ignoreNulls);
    } else if (rel instanceof HiveSemiJoin) {
      return getUniqueKeys((HiveSemiJoin) rel, ignoreNulls);
    } else if (rel instanceof HiveAggregate) {
      return getUniqueKeys((HiveAggregate) rel, ignoreNulls);
    } else if (rel instanceof SetOp) {
      return getUniqueKeys((SetOp) rel, ignoreNulls);
    } else {
      return null;
    }
  }
