...
class CheckConstraintsResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i324 in xrange(_size320):
            _elem325 = SQLCheckConstraint()
            _elem325.read(iprot)
            self.checkConstraints.append(_elem325)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.checkConstraints is not None:
      ...
      for iter326 in self.checkConstraints:
        iter326.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class AddPrimaryKeyRequest:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i331 in xrange(_size327):
            _elem332 = SQLPrimaryKey()
            _elem332.read(iprot)
            self.primaryKeyCols.append(_elem332)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.primaryKeyCols is not None:
      ...
      for iter333 in self.primaryKeyCols:
        iter333.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class AddForeignKeyRequest:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i338 in xrange(_size334):
            _elem339 = SQLForeignKey()
            _elem339.read(iprot)
            self.foreignKeyCols.append(_elem339)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.foreignKeyCols is not None:
      ...
      for iter340 in self.foreignKeyCols:
        iter340.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class AddUniqueConstraintRequest:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i345 in xrange(_size341):
            _elem346 = SQLUniqueConstraint()
            _elem346.read(iprot)
            self.uniqueConstraintCols.append(_elem346)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.uniqueConstraintCols is not None:
      ...
      for iter347 in self.uniqueConstraintCols:
        iter347.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class AddNotNullConstraintRequest:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i352 in xrange(_size348):
            _elem353 = SQLNotNullConstraint()
            _elem353.read(iprot)
            self.notNullConstraintCols.append(_elem353)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.notNullConstraintCols is not None:
      ...
      for iter354 in self.notNullConstraintCols:
        iter354.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class AddDefaultConstraintRequest:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i359 in xrange(_size355):
            _elem360 = SQLDefaultConstraint()
            _elem360.read(iprot)
            self.defaultConstraintCols.append(_elem360)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.defaultConstraintCols is not None:
      ...
      for iter361 in self.defaultConstraintCols:
        iter361.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class AddCheckConstraintRequest:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i366 in xrange(_size362):
            _elem367 = SQLCheckConstraint()
            _elem367.read(iprot)
            self.checkConstraintCols.append(_elem367)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.checkConstraintCols is not None:
      ...
      for iter368 in self.checkConstraintCols:
        iter368.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class PartitionsByExprResult:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i373 in xrange(_size369):
            _elem374 = Partition()
            _elem374.read(iprot)
            self.partitions.append(_elem374)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.partitions is not None:
      oprot.writeFieldBegin('partitions', TType.LIST, 1)
      oprot.writeListBegin(TType.STRUCT, len(self.partitions))
      for iter375 in self.partitions:
        iter375.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
...
class TableStatsResult:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i380 in xrange(_size376):
            ...
            _elem381.read(iprot)
            self.tableStats.append(_elem381)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.tableStats is not None:
      ...
      for iter382 in self.tableStats:
        iter382.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class PartitionsStatsResult:
        ...
        if ftype == TType.MAP:
          ...
          for _i387 in xrange(_size383):
            ...
            for _i394 in xrange(_size390):
              _elem395 = ColumnStatisticsObj()
              _elem395.read(iprot)
              _val389.append(_elem395)
            iprot.readListEnd()
            self.partStats[_key388] = _val389
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.partStats is not None:
      ...
      for kiter396,viter397 in self.partStats.items():
        oprot.writeString(kiter396)
        oprot.writeListBegin(TType.STRUCT, len(viter397))
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i416 in xrange(_size412):
            ...
            self.partNames.append(_elem417)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class DropPartitionsResult:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i438 in xrange(_size434):
            _elem439 = Partition()
            _elem439.read(iprot)
            self.partitions.append(_elem439)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.partitions is not None:
      oprot.writeFieldBegin('partitions', TType.LIST, 1)
      oprot.writeListBegin(TType.STRUCT, len(self.partitions))
      for iter440 in self.partitions:
        iter440.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i451 in xrange(_size447):
            _elem452 = DropPartitionsExpr()
            _elem452.read(iprot)
            self.exprs.append(_elem452)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class PartitionValuesRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i459 in xrange(_size455):
            _elem460 = FieldSchema()
            _elem460.read(iprot)
            self.partitionKeys.append(_elem460)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        ...
        if ftype == TType.LIST:
          ...
          for _i465 in xrange(_size461):
            _elem466 = FieldSchema()
            _elem466.read(iprot)
            self.partitionOrder.append(_elem466)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 7:
  ...
  def write(self, oprot):
    ...
    if self.partitionKeys is not None:
      ...
      oprot.writeListBegin(TType.STRUCT, len(self.partitionKeys))
      for iter467 in self.partitionKeys:
        iter467.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    ...
    if self.partitionOrder is not None:
      ...
      for iter468 in self.partitionOrder:
        iter468.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
...
class PartitionValuesResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i480 in xrange(_size476):
            _elem481 = PartitionValuesRow()
            _elem481.read(iprot)
            self.partitionValues.append(_elem481)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.partitionValues is not None:
      ...
      for iter482 in self.partitionValues:
        iter482.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class Function:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i487 in xrange(_size483):
            _elem488 = ResourceUri()
            _elem488.read(iprot)
            self.resourceUris.append(_elem488)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.resourceUris is not None:
      ...
      for iter489 in self.resourceUris:
        iter489.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i494 in xrange(_size490):
            _elem495 = TxnInfo()
            _elem495.read(iprot)
            self.open_txns.append(_elem495)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i501 in xrange(_size497):
            ...
            self.open_txns.append(_elem502)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
...
class GetValidWriteIdsRequest:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i522 in xrange(_size518):
            ...
            self.fullTableNames.append(_elem523)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.fullTableNames is not None:
      ...
      for iter524 in self.fullTableNames:
...
class TableValidWriteIds:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i529 in xrange(_size525):
            ...
            self.invalidWriteIds.append(_elem530)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.invalidWriteIds is not None:
      ...
      for iter531 in self.invalidWriteIds:
...
class GetValidWriteIdsResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i536 in xrange(_size532):
            _elem537 = TableValidWriteIds()
            _elem537.read(iprot)
            self.tblValidWriteIds.append(_elem537)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.tblValidWriteIds is not None:
      ...
      for iter538 in self.tblValidWriteIds:
        iter538.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class AllocateTableWriteIdsResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i550 in xrange(_size546):
            _elem551 = TxnToWriteId()
            _elem551.read(iprot)
            self.txnToWriteIds.append(_elem551)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.txnToWriteIds is not None:
      ...
      for iter552 in self.txnToWriteIds:
        iter552.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i557 in xrange(_size553):
            _elem558 = LockComponent()
            _elem558.read(iprot)
            self.component.append(_elem558)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i564 in xrange(_size560):
            _elem565 = ShowLocksResponseElement()
            _elem565.read(iprot)
            self.locks.append(_elem565)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class CompactionRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i585 in xrange(_size581):
            ...
            self.properties[_key586] = _val587
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.properties is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.properties))
      for kiter588,viter589 in self.properties.items():
        oprot.writeString(kiter588)
        oprot.writeString(viter589)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i594 in xrange(_size590):
            _elem595 = ShowCompactResponseElement()
            _elem595.read(iprot)
            self.compacts.append(_elem595)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class AddDynamicPartitions:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i601 in xrange(_size597):
            ...
            self.partitionnames.append(_elem602)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 6:
  ...
  def write(self, oprot):
    ...
    if self.partitionnames is not None:
      ...
      for iter603 in self.partitionnames:
...
class CreationMetadata:
  ...
  def write(self, oprot):
    ...
    if self.tablesUsed is not None:
      ...
      for iter610 in self.tablesUsed:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i615 in xrange(_size611):
            _elem616 = NotificationEvent()
            _elem616.read(iprot)
            self.events.append(_elem616)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class InsertEventRequestData:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i622 in xrange(_size618):
            ...
            self.filesAdded.append(_elem623)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.LIST:
          ...
          for _i628 in xrange(_size624):
            ...
            self.filesAddedChecksum.append(_elem629)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.filesAdded is not None:
      ...
      for iter630 in self.filesAdded:
    ...
    if self.filesAddedChecksum is not None:
      ...
      for iter631 in self.filesAddedChecksum:
...
class FireEventRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i636 in xrange(_size632):
            ...
            self.partitionVals.append(_elem637)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.partitionVals is not None:
      ...
      for iter638 in self.partitionVals:
...
class GetFileMetadataResult:
  ...
  def write(self, oprot):
    ...
    if self.metadata is not None:
      ...
      for kiter662,viter663 in self.metadata.items():
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i696 in xrange(_size692):
            _elem697 = Function()
            _elem697.read(iprot)
            self.functions.append(_elem697)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class Materialization:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.SET:
          self.tablesUsed = set()
          (_etype723, _size720) = iprot.readSetBegin()
          for _i724 in xrange(_size720):
            _elem725 = iprot.readString()
            self.tablesUsed.add(_elem725)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.tablesUsed is not None:
      ...
      oprot.writeSetBegin(TType.STRING, len(self.tablesUsed))
      for iter726 in self.tablesUsed:
...
class WMFullResourcePlan:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i749 in xrange(_size745):
            _elem750 = WMPoolTrigger()
            _elem750.read(iprot)
            self.poolTriggers.append(_elem750)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.poolTriggers is not None:
      ...
      for iter754 in self.poolTriggers:
        iter754.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class WMGetAllResourcePlanResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i759 in xrange(_size755):
            _elem760 = WMResourcePlan()
            _elem760.read(iprot)
            self.resourcePlans.append(_elem760)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.resourcePlans is not None:
      ...
      for iter761 in self.resourcePlans:
        iter761.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
