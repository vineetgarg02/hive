  ...
  private static class PutFileMetadataRequestTupleScheme extends TupleScheme<PutFileMetadataRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, PutFileMetadataRequest struct) throws org.apache.thrift.TException {
      ...
      }
      {
        ...
        for (ByteBuffer _iter771 : struct.metadata)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PutFileMetadataRequest struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TList _list772 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
        struct.fileIds = new ArrayList<Long>(_list772.size);
        long _elem773;
        for (int _i774 = 0; _i774 < _list772.size; ++_i774)
        {
          _elem773 = iprot.readI64();
          struct.fileIds.add(_elem773);
        }
      }
      struct.setFileIdsIsSet(true);
      {
        ...
        struct.metadata = new ArrayList<ByteBuffer>(_list775.size);
        ByteBuffer _elem776;
        for (int _i777 = 0; _i777 < _list775.size; ++_i777)
        {
          _elem776 = iprot.readBinary();
          struct.metadata.add(_elem776);
        }
      }
      struct.setMetadataIsSet(true);
